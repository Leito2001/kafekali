...
function checkUsuarios()
{
    ...
    .done(function( response ) {
        ...
        if ( current == '/kafekali2/views/dashboard/register.php' ) {
...
function signOff()
{
    ...
    .then(function( value ) {
        ...
        if ( value ) {
            ...
            sweetAlert( 4, 'Puede continuar la sesión', null );
        }
    });
}
...
function openModalProfile()
{
    ...
    .done(function( response ) {
        ...
        if ( response.status ) {
            ...
            $( '#nombres_perfil' ).val( response.dataset.nombres );
            $( '#apellidos_perfil' ).val( response.dataset.apellidos );
            $( '#correo_perfil' ).val( response.dataset.correo );
            $( '#alias_perfil' ).val( response.dataset.usuario_u );
            $( '#celular_perfil' ).val( response.dataset.celular );
